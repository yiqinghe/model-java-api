...
import com.auto.trade.common.Md5SignUtil;
import com.auto.trade.common.coinex.MD5Util;
...
//        params.put("type","buy");
        ...
        // todo 和官方的不一致，用的是官方提供的demo，python版本的测试过，和java demo一样的结果
        String xxx = MD5Util.buildMysignV1(params,Constants.SECRET);
