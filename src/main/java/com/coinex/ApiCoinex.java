 ...
 */
public class ApiCoinex implements Api<Object> {
    private static final Logger log = LoggerFactory.getLogger(ApiCoinex.class);
    public static String url = "https://api.coinex.com/v1/";
...
//        return targetAmount;
    ...
    public String buildSign(String http_head, String path, Map<String, String> params, long systemTimeMillsecs) {
        params.put("access_id",Constants.APIKEY);
        params.put("tonce",systemTimeMillsecs+"");
        String urlParas = SignUtil.formatUrlMap(params,false,false);
        urlParas= urlParas+"&secret_key="+Constants.SECRET;
        String sign = Md5SignUtil.string2MD5(urlParas);
