 ...
 */
public class HttpUtilForCoinex {
    private static final Logger log = LoggerFactory.getLogger(HttpUtilForCoinex.class);
    ...
    public static String doGetRequest(String url,String sign,long systemTimeMillsecs){
        ...
        httpGet2.setHeader("AUTHORIZATION",sign);
        ...
        httpGet2.setHeader("User-Agent","Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/60.0.3112.90 Safari/537.36");
